...
return [
    ...
    */
    ...
    'min' => [
        ...
        'file' => 'Le champ :attribute doit être au moins de :min kilooctets.',
    ...
    'missing_if' => 'Le champ :attribute doit manquer lorsque :other est :value.',
    'missing_unless' => 'Le champ :attribute doit manquer à moins que :other ne soit :value.',
    'missing_with' => 'Le champ :attribute doit manquer lorsque :values est présent.',
    'missing_with_all' => 'Le champ :attribute doit manquer lorsque :values sont présents.',
    ...
    | convention "attribute.rule" pour nommer les lignes. Cela rend rapide la
    | spécification d'une ligne de langue personnalisée spécifique pour une règle d'attribut donnée.
    |
    */
    ...
    | par quelque chose de plus convivial pour le lecteur, comme "Adresse E-Mail" au lieu
